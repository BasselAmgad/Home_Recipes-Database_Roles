...
namespace HomeRecipes_UserRoles_v1.EntityClasses
{
	...
	
	{
		...
		protected class UserRoleEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("UserRoleEntity", InheritanceHierarchyType.None, false, (int)HomeRecipes_UserRoles_v1.EntityType.UserRoleEntity, typeof(UserRoleEntity), typeof(UserRoleEntityFactory), false);
				AddNavigatorMetaData<UserRoleEntity, RoleEntity>("Role", "UserRoles", (a, b) => a._role = b, a => a._role, (a, b) => a.Role = b, HomeRecipes_UserRoles_v1.RelationClasses.StaticUserRoleRelations.RoleEntityUsingRoleIdStatic, ()=>new UserRoleRelations().RoleEntityUsingRoleId, null, new int[] { (int)UserRoleFieldIndex.RoleId }, null, true, (int)HomeRecipes_UserRoles_v1.EntityType.RoleEntity);
				AddNavigatorMetaData<UserRoleEntity, UserEntity>("User", "UserRoles", (a, b) => a._user = b, a => a._user, (a, b) => a.User = b, HomeRecipes_UserRoles_v1.RelationClasses.StaticUserRoleRelations.UserEntityUsingUserIdStatic, ()=>new UserRoleRelations().UserEntityUsingUserId, null, new int[] { (int)UserRoleFieldIndex.UserId }, null, true, (int)HomeRecipes_UserRoles_v1.EntityType.UserEntity);
			}
		}
		...
		/// <remarks>Mapped on  table field: "UserRoles"."id".<br/>Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		...
		/// <remarks>Mapped on  table field: "UserRoles"."is_active".<br/>Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		...
		/// <remarks>Mapped on  table field: "UserRoles"."role_id".<br/>Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		...
		/// <remarks>Mapped on  table field: "UserRoles"."user_id".<br/>Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Guid UserId
		{
			get { return (System.Guid)GetValue((int)UserRoleFieldIndex.UserId, true); }
