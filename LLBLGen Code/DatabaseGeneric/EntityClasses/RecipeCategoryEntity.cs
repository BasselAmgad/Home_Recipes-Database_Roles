...
namespace HomeRecipes_UserRoles_v1.EntityClasses
{
	...
	
	{
		...
		public RecipeCategoryEntity(System.Int32 id) : this(id, null)
		{
		}
		...
		/// <param name="id">PK value for RecipeCategory which data should be fetched into this RecipeCategory object</param>
		/// <param name="validator">The custom validator object for this RecipeCategoryEntity</param>
		public RecipeCategoryEntity(System.Int32 id, IValidator validator)
		{
			InitClassEmpty(validator, null);
			this.Id = id;
		}
		...
		/// <remarks>Mapped on  table field: "RecipeCategory"."category_id".<br/>Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Guid CategoryId
		{
			get { return (System.Guid)GetValue((int)RecipeCategoryFieldIndex.CategoryId, true); }
		...
		/// <remarks>Mapped on  table field: "RecipeCategory"."id".<br/>Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int32 Id
		{
			get { return (System.Int32)GetValue((int)RecipeCategoryFieldIndex.Id, true); }
		...
		/// <remarks>Mapped on  table field: "RecipeCategory"."is_active".<br/>Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		...
		/// <remarks>Mapped on  table field: "RecipeCategory"."recipe_id".<br/>Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
